...
def test_tags(insights_client, external_inventory, test_config):
    ...
    :steps:
        1. Register insights-client, and check satellite related
            tags on the inventory if the test env is satellite.
    ...
    :expectedresults:
        1. System is registered to insights, and there will be
            ...
            satellite env.
        2. File tags.yaml will be created with group option, and new
            tag generated by tags.yaml
    ...
    with contextlib.ExitStack() as stack:
        ...
        assert conftest.loop_until(first_tag_present)
        ...
        assert conftest.loop_until(second_tag_present)
